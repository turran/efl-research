...
#define ESVG_CONTAINER(obj)       (EOBJ_OBJECT_CAST((obj), ESVG_CONTAINER_CLASS, ESVG_Container))
#define ESVG_IS_CONTAINER(obj)    (EOBJ_OBJECT_CHECK_CLASS((obj), ESVG_CONTAINER_CLASS))
