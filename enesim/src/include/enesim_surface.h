...
EAPI Enesim_Surface * enesim_surface_new(Enesim_Surface_Format f, int w, int h, Enesim_Surface_Flag flags, Enesim_Surface_Data *sdata);
...
EAPI void enesim_surface_data_get(Enesim_Surface *s, Enesim_Surface_Data *sdata);
EAPI void enesim_surface_data_set(Enesim_Surface *s, Enesim_Surface_Data *sdata);
