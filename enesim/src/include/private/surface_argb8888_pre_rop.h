...
static inline unsigned char argb8888_pre_alpha_get(unsigned int plane0)
{
	return (plane0 >> 24);
}

static inline unsigned char argb8888_pre_red_get(unsigned int plane0)
{
	return ((plane0 >> 16) & 0xff);
}

static inline unsigned char argb8888_pre_green_get(unsigned int plane0)
{
	return ((plane0 >> 8) & 0xff);
}

static inline unsigned char argb8888_pre_blue_get(unsigned int plane0)
{
	return (plane0 & 0xff);
}

static inline void argb8888_pre_from_components(unsigned int *plane0, unsigned char a, unsigned char r,
		unsigned char g, unsigned char b)
{
	*plane0 = (a << 24) | (r << 16) | (g << 8) | b;
}

static inline void argb8888_pre_to_components(unsigned int plane0, unsigned char *a, unsigned char *r,
		unsigned char *g, unsigned char *b)
{
	if (a) *a = argb8888_pre_alpha_get(plane0);
	if (r) *r = argb8888_pre_red_get(plane0);
	if (g) *g = argb8888_pre_green_get(plane0);
	if (b) *b = argb8888_pre_blue_get(plane0);
}

static inline void argb8888_pre_to_argb(unsigned int *argb, unsigned int plane0)
{
	unsigned int a = argb8888_pre_alpha_get(plane0);
	
	if ((a > 1) && (a < 255))
	{
		unsigned char r, g, b;
		
		r = argb8888_pre_red_get(plane0);
		g = argb8888_pre_green_get(plane0);
		b = argb8888_pre_blue_get(plane0);
...
static inline void argb8888_pre_blend(unsigned int *dplane0, unsigned int splane0)
{
	...
	a = 256 - argb8888_pre_alpha_get(splane0);
