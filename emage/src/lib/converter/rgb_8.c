...
void emage_convert_rgba_to_8bpp_rgb_332_dith     (DATA32 *src, DATA8 *dst, int src_jump, int dst_jump, int w, int h, int dith_x, int dith_y, DATA8 *pal)
{
   DATA32 *src_ptr;
   DATA8 *dst_ptr;
   int x, y;
...
void emage_convert_rgba_to_8bpp_rgb_666_dith     (DATA32 *src, DATA8 *dst, int src_jump, int dst_jump, int w, int h, int dith_x, int dith_y, DATA8 *pal)
{
   DATA32 *src_ptr;
   DATA8 *dst_ptr;
   int x, y;
...
void emage_convert_rgba_to_8bpp_rgb_232_dith     (DATA32 *src, DATA8 *dst, int src_jump, int dst_jump, int w, int h, int dith_x, int dith_y, DATA8 *pal)
{
   DATA32 *src_ptr;
   DATA8 *dst_ptr;
   int x, y;
...
void emage_convert_rgba_to_8bpp_rgb_222_dith     (DATA32 *src, DATA8 *dst, int src_jump, int dst_jump, int w, int h, int dith_x, int dith_y, DATA8 *pal)
{
   DATA32 *src_ptr;
   DATA8 *dst_ptr;
   int x, y;
...
void emage_convert_rgba_to_8bpp_rgb_221_dith     (DATA32 *src, DATA8 *dst, int src_jump, int dst_jump, int w, int h, int dith_x, int dith_y, DATA8 *pal)
{
   DATA32 *src_ptr;
   DATA8 *dst_ptr;
   int x, y;
...
void emage_convert_rgba_to_8bpp_rgb_121_dith     (DATA32 *src, DATA8 *dst, int src_jump, int dst_jump, int w, int h, int dith_x, int dith_y, DATA8 *pal)
{
   DATA32 *src_ptr;
   DATA8 *dst_ptr;
   int x, y;
...
void emage_convert_rgba_to_8bpp_rgb_111_dith     (DATA32 *src, DATA8 *dst, int src_jump, int dst_jump, int w, int h, int dith_x, int dith_y, DATA8 *pal)
{
   DATA32 *src_ptr;
   DATA8 *dst_ptr;
   int x, y;
...
{
#ifdef BUILD_CONVERT_8_RGB_332
	     if (pal_mode == EMAGE_PAL_MODE_RGB332)
	       return emage_convert_rgba_to_8bpp_rgb_332_dith;
#endif
#ifdef BUILD_CONVERT_8_RGB_666
	     if (pal_mode == EMAGE_PAL_MODE_RGB666)
	       return emage_convert_rgba_to_8bpp_rgb_666_dith;
#endif
#ifdef BUILD_CONVERT_8_RGB_232
	     if (pal_mode == EMAGE_PAL_MODE_RGB232)
	       return emage_convert_rgba_to_8bpp_rgb_232_dith;
#endif
#ifdef BUILD_CONVERT_8_RGB_222
	     if (pal_mode == EMAGE_PAL_MODE_RGB222)
	       return emage_convert_rgba_to_8bpp_rgb_222_dith;
#endif
#ifdef BUILD_CONVERT_8_RGB_221
	     if (pal_mode == EMAGE_PAL_MODE_RGB221)
	       return emage_convert_rgba_to_8bpp_rgb_221_dith;
#endif
#ifdef BUILD_CONVERT_8_RGB_121
	     if (pal_mode == EMAGE_PAL_MODE_RGB121)
	       return emage_convert_rgba_to_8bpp_rgb_121_dith;
#endif
#ifdef BUILD_CONVERT_8_RGB_111
	     if (pal_mode == EMAGE_PAL_MODE_RGB111)
	       return emage_convert_rgba_to_8bpp_rgb_111_dith;
#endif
	return NULL;
}
