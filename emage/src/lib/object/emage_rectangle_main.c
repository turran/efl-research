...
static void rectangle_draw_internal(RGBA_Surface *dst, RGBA_Draw_Context *dc, int x, int y, int w, int h);
...
EAPI void
evas_common_rectangle_draw(RGBA_Surface *dst, RGBA_Draw_Context *dc, int x, int y, int w, int h)
{
   Cutout_Rects *rects;
   Cutout_Rect  *r;
   int          c, cx, cy, cw, ch;
